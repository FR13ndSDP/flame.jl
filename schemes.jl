...
function WENO_x(F, Fp, Fm, NG, Nx, Ny, NV)
    ...
    for n = 1:NV
        ...
        @inbounds V1 = Fm[i-1+NG, j+1+NG, n]
        @inbounds V2 = Fm[i+NG,   j+1+NG, n]
        @inbounds V3 = Fm[i+1+NG, j+1+NG, n]
